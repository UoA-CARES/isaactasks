...
from .anymal_env_cfg import  AnymalEnvCfg  # AnymalCFlatEnvCfg, AnymalCRoughEnvCfg


class AnymalEnv(DirectRLEnv):
    cfg:  AnymalEnvCfg# AnymalCFlatEnvCfg | AnymalCRoughEnvCfg

    def __init__(self, cfg: AnymalEnvCfg, render_mode: str | None = None, **kwargs): # AnymalCFlatEnvCfg | AnymalCRoughEnvCfg
    ...
    def _setup_scene(self):
        ...
        if isinstance(self.cfg, AnymalEnvCfg):
